	...
	<div class="nk-wrap">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-lg-5 order-lg-last">
                                        <div class="banner-gfx animated" data-animate="fadeInUp" data-delay=".9">
                                            <img src="images/header/logotipo4dev.png" alt="header" style="width: 500px;">
                                        </div>
                                    </div><!-- .col -->
                                        ...
                                        <div class="banner-caption cpn tc-light">
                                            ...
                                            <div class="cpn-action">
                                                <div class="cpn-btns animated" data-animate="fadeInUp" data-delay="1.2">
                                                    <a class="btn btn-grad" href="#contact">Cotiza con nosotros</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
        ...
        <main class="nk-pages">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="feature animated" data-animate="fadeInUp" data-delay=".8">
                                    <div class="feature-icon dot">
                                        <em class="icon ikon ikon-cloud"></em>
                                    </div>
                                    <div class="feature-text">
                            ...
                            <div class="col-lg-4">
                                <div class="feature animated" data-animate="fadeInUp" data-delay=".9">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Contamos con personal capacitado en dar consultarias a su empresa, potenciando su negocio.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="bg-theme bg-pattern-dots" id="tokens">
                ...
                <div class="container">
                    <!-- Block @s -->
                    <div class="nk-block nk-block-features-4 mgb-m30">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="section-head">
                ...
                <div class="container">
                    ...
                    <div class="nk-block nk-block-text-wrap">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <div class="nk-block-text">
                                    <h6 class="title title-xs tc-primary">Bienvenido al mundo de la digitalizacion</h6>
                                    <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">Digitaliza tú negocio</h2>
                                    <p class="animated" data-animate="fadeInUp" data-delay=".3">Probablemente la palabra que espanta a muchos y entusiasma a otros ofrece múltiples opciones, transformando con el término digitalizar negocios tradicionales la productividad de tu empresa.<br>
Existen algunos aspectos muy positivos para conocer las principales ventajas de esta técnica que te permite crear estrategias, aprendiendo cómo digitalizar mi negocio con los consejos de los profesionales.</p>
                                    <ul class="list list-check animated" data-animate="fadeInUp" data-delay=".4">
                                        ...
                                        <li>Aumento de la facturación.</li>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
                                <ul class="nav tab-nav tab-nav-vr tab-nav-bdr mr-lg-3 animated" data-animate="fadeInUp" data-delay=".3">
                                    <li><a class="active" data-toggle="tab" href="#general-questions"><em class="fas fa-caret-right"></em>Preguntas Generales</a></li>
                                    ...
                                    <div class="tab-pane fade show active" id="general-questions">
                                        <div class="accordion accordion-faq" id="faq-1">
                                            <div class="accordion-item">
                                                <h5 class="accordion-title accordion-title-sm" data-toggle="collapse" data-target="#faq-1-1">Quienes somos?<span class="accordion-icon"></span></h5>
                                            ...
                                            <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".2">
                                                <h5 class="accordion-title accordion-title-sm collapsed" data-toggle="collapse" data-target="#faq-1-2">En qué nos especializamos? <span class="accordion-icon"></span></h5>
                                            ...
                                            <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".3">
                                                <h5 class="accordion-title accordion-title-sm collapsed" data-toggle="collapse" data-target="#faq-1-3">Por qué 4dev? <span class="accordion-icon"></span></h5>
                        ...
                        <div class="row justify-content-center no-gutters">
                            <div class="col-lg-6">
                                <div class="contact-wrap split split-left split-lg-left bg-white">
                                    <h5 class="title title-md">Contactanos</h5>
                                    <form class="nk-form-submit" name="formular"  method="post" action="contacto.php">
                                        <div class="field-item">
                                            <input name="name" required type="text" class="input-line required">
                                            <label class="field-label field-label-line">Nombre</label>
                                        </div>
                                        <div class="field-item">
                                            <input name="email" required type="email" class="input-line required email">
                                            <label class="field-label field-label-line">Email</label>
                                        </div>
                                        <div class="field-item">
                                            <textarea name="message" required
                                                class="input-line input-textarea required"></textarea>
                                            <label class="field-label field-label-line">Mensaje</label>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <button type="submit" onclick="myFunction()" class="btn btn-lg btn-grad">Enviar</button>
                                            </div>
                                            <div class="col-sm-8">
